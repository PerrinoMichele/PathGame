...
public class PlayerController : MonoBehaviour
{
    ...
    void Start()
    {
        Instantiate(boxAim, transform.position + Vector3.up, Quaternion.identity);
    }
    ...
    void ShowBoxAim()
    {
        boxAim.GetComponent<Rigidbody>().AddForce(transform.forward * fruitShootingForce);
    }
