...
public class PredictTrajectory : MonoBehaviour
{
    ...
    {
        int throwableObjectLayer = playerController.currentThrowableObject.layer;
        for (int i = 0; i < 32; i++)
        {
    ...
    private void DrawProjection()
    {
        ...
        Vector3 startVelocity = 10 * transform.forward / playerController.currentThrowableObject.GetComponent<Rigidbody>().mass;//hook up the variable instead of 10 (variable will probably differ according to weapon); 
        int i = 0;
