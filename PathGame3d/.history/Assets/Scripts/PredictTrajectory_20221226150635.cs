...
public class PredictTrajectory : MonoBehaviour
{
    ...
    private void DrawProjection()
    {
        ...
        Vector3 startVelocity = 5 * transform.forward / boxPrefab.GetComponent<Rigidbody>().mass;//hook up the variable instead of 10 (variable will probably differ according to weapon); 
        int i = 0;
