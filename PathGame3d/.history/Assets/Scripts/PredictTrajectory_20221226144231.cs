...
public class PredictTrajectory : MonoBehaviour
{
    ...
    {
        int boxLayer = playerController.currentThrowableObject.gameObject.layer;//rename with throwableObjectLayer & replace boxprefab with the object we need to shoot
        for (int i = 0; i < 32; i++)
        {
