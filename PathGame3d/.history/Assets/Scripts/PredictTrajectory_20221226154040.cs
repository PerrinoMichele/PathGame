...
public class PredictTrajectory : MonoBehaviour
{
    ...
    private void DrawProjection(GameObject currentObject)
    {
        ...
        Vector3 startVelocity = 600 * transform.forward / currentObject.GetComponent<Rigidbody>().mass;//hook up the variable instead of 10 (variable will probably differ according to weapon); 
        int i = 0;
